  ...
  const renderScheteacher = (value,index) => {
    ...
    return(
      <div className="chose" key={index}>
        <div className="box_sub_id">{}</div>
        <div className="box_sub_name">{}</div>
        <div className="box_sub_credit">{}</div>
        <div className="box_sub_sec">{value}</div>
        <div className="box_sub_no">{value}</div>
        <div className="box_sub_force_or_not">{value}</div>
        <div className="box_sub_major">{value}</div>
        <div className="box_sub_day">{value}</div>
      </div>
    )
  }
    ...
    <div className="allbox">
      ...
      <div>
        ...
        <div className="scroll-scheteacher">
          {selectedSubjects.map(renderScheteacher)}
        </div>
